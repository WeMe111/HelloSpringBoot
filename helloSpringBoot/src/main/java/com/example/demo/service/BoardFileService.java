...
public class BoardFileService {
	...
	public void save(BoardFile boardFile) {
		...
		file.setFilename(boardFile.getFilename());
		file.setFileOriName(boardFile.getFileOriName());
		file.setFileurl(boardFile.getFileurl());
...
//		if(boardId == null) throw new NullPointerException("EmptyBOARD_ID.");
//		
//		//파라미터 이름을 키로 파라미터에 해당하는 파일 정보를 갑으로 하는 Map을 가져온다.
...
//			if (fileSize > 0) {
//				
//				String filePath = "C:\\Users\\nmplus\\git\\repository\\helloSpringBoot\\uploadFiles\\";
//				
...
//				String savaFilePath = filePath + File.separator + saveFileName;
//				
